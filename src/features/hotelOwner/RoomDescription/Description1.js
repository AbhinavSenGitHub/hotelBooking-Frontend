...
const Description1 = () => {
    ...
    const { hotel, room } = useLocation().state || {}
    console.log("location1: ", hotel, room)
    ...
    return (
        <div>
            ...
            {hotel && <div className='my-10 px-4 sm:px-16 '>
                {room && <div className='mb-10'>
                    <h1 className='text-2xl font-medium'>{hotel.hotelName}</h1>
                    <p className='text-lg text-gray-600'>{hotel.hotelAddress}</p>
                </div>}
                    ...
                    <div className='lg:col-span-3 flex flex-col gap-3'>
                        ...
                        <div className='flex flex-wrap gap-3'>
                            <div className='md:flex fle-wrap custom-1427:flex-col  gap-3'>
                                <div className='h-[250px] lg:w-[250px] mb-3'><img className=' h-[250px] object-cover  rounded-lg' src={room.roomImages[0]} alt='room image' /></div>
                                <div className='h-[250px] lg:w-[250px]'><img className=' h-full w-full object-cover  rounded-lg' src={room.roomImages[1]} alt='room image' /></div>
                            ...
                            <div className='custom-1427:w-fit w-full'>
                                <div className='custom-1427:h-[350px] md:h-[350px] h-[250px] custom-1427:w-full sm:w-3/4  mb-3'>
                                    <img className=' h-full w-full rounded-lg' src={room.roomImages[2]} />
                                </div>
                                <div className='flex flex-wrap gap-3'>
                                    <div className='lg:h-[160px] h-[250px]'>
                                        <img className=' h-full w-full rounded-lg' src={room.roomImages[3]} />
                                    </div>
                                    <div className='lg:h-[160px] h-[250px]'>
                                        <img className='h-full w-full rounded-lg' src={room.roomImages[4]} />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='lg:w-fit  h-fit flex flex-col gap-3'>
                        <div className='border px-2 rounded-xl py-2'>
                            ...
                            <ul className='px-1 clear-start'>
                                {hotel && hotel.keyPoints.map((item, index) => (
                        ...
                        <div className='py-2 rounded-xl'>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className='flex  flex-wrap w-full'>
                                    <div className='flex flex-col pr-3 w-1/2 gap-2'>
                                    ...
                                    <div className='flex flex-col w-1/2 pr-3 mb-3 gap-2'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input
                                        ...
                                        {...register("numberOfGuests", {
                                            ...
                                            validate: (value) =>
                                                value <= room.capacity || `Number of guests must not exceed ${room.capacity}`,
                                        })}
